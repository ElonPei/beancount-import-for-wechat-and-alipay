class Bean:
    def __init__(self, id, remark, relation, tags, date, datetime, trace_type, trace_obj, desc, items, income_and_expenses,
                 pay_way,
                 status, order_no, source, owner, trace_change_rule):
        self.id = id
        self.remark = remark
