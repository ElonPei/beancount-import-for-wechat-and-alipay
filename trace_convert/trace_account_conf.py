...
trace_change_map = {
    ...
    "goods=转账收款到余额宝": "income_and_expenses=支出",
    "trace_type=零钱充值": "income_and_expenses=支出",
    "trace_type=转入零钱通-来自零钱": "income_and_expenses=支出",
    "trace_type=还款": "income_and_expenses=支出",
    "goods=还款": "income_and_expenses=支出",
    "goods=快的打车红包": "pay_way=余额,income_and_expenses=收入",
    "trace_type=提现": "income_and_expenses=支出",
    "goods=提现": "income_and_expenses=支出",
    "trace_type=零钱通转出-到零钱": "income_and_expenses=支出",
    "trace_type=零钱通转出-到工商银行(6086)": "income_and_expenses=支出",
    "goods=退款": "income_and_expenses=收入",
    "goods=余额宝-转出": "income_and_expenses=支出",
    ...
    "goods=余额宝-单次转入": "income_and_expenses=收入",
    ...
    "goods=转账到银行卡": "income_and_expenses=支出",
    "goods=转出到余额": "income_and_expenses=收入,pay_way=余额",
    "goods=定期理财-": "income_and_expenses=支出",
    "goods=红包奖励发放": "income_and_expenses=收入,pay_way=余额宝",
    "goods=买入": "income_and_expenses=支出",
    "goods=卖出至余额宝": "income_and_expenses=收入",
    "goods=借呗放款至余额": "income_and_expenses=收入",
    "goods=卖出至银行卡": "income_and_expenses=收入",
